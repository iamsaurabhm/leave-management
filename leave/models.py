...
class Leave(models.Model):
	...
	startdate = models.DateField(verbose_name=_('Start Date'),help_text='leave start date..',null=True,blank=False)
	enddate = models.DateField(verbose_name=_('End Date'),help_text='leave end date...',null=True,blank=False)
