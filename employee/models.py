...
class Employee(models.Model):
    ...
    image = models.FileField(_('Profile Image'),upload_to='profiles',null=True,blank=True,help_text='upload image size less than 2.0MB')#work on path username-date/image
