...
class EmployeeEditForm(forms.ModelForm):
	employeeid = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'please enter 5 characters without ZP or slashes eg. A0025'}))
	image = forms.FileField(widget=forms.FileInput(attrs={'onchange':'previewImage(this);'}))
...
class EventForm(forms.ModelForm):
	event_date = forms.DateField(input_formats=settings.DATE_INPUT_FORMATS,widget=forms.widgets.DateInput(attrs={'class': 'form-control datepicker',}))
	class Meta:
		model = Event
