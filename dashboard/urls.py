...
urlpatterns = [
    ...
    path('employee/policy/',views.policy,name='policy'),
    path('employee/events/',views.events,name='events'),
    path('employee/complain/',views.complaint_view,name='complain'),
    path('employee/complain_detail/<int:pk>',views.complain_detail,name='complain_detail'),
    ...
    # Attendance
    # path('attendance/table/',views.show_attendance,name='attendance_table'),
    # path('attendance/',views.attendance_creation,name='attendance'),
]
